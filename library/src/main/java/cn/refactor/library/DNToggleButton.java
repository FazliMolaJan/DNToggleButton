...
public class DNToggleButton extends View implements Checkable {
    ...
    private static final int COLOR_CHECKED_FLOOR = Color.parseColor("#8EDCFA");
    private static final int COLOR_UNCHECKED_FLOOR = Color.parseColor("#2E3235");
